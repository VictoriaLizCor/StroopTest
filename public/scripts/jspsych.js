...
jsPsych.data = (function() {
  ...
  module.write = function(data_object) {
    ...
    //////////////////////////////////////
    //added code to get current time 
    ...
    function get_time(){
      ...
      let formattedDate = addLeadingZeros(currentDatetime.getHours()) + ":" + addLeadingZeros(currentDatetime.getMinutes()) + ":" + addLeadingZeros(currentDatetime.getSeconds()) + ":" + currentDatetime.getMilliseconds();
    ...
    var default_data = {
      ...
      'date': new Date().toLocaleDateString('es-us', { year:"numeric", month:"numeric", day:"numeric"}),
      'time':  get_time(),
      //'time': new Date().toLocaleString('es-US', { hour: 'numeric', minute: 'numeric', second: 'numeric'}),
    };
